...
class MojaAplikacja(QtWidgets.QMainWindow):
    ...
    def przetwarzankoZDJ(self):
        ...
        markers_copy = list(self.chunk.markers)
        ...
        while len(self.chunk.markers) > length:
            last_marker = self.chunk.markers[-1]

            self.chunk.remove(last_marker)
